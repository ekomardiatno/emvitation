...
export default function PressableCard({ title, iconName, shotDescription, onPress }: {
  ...
  return (
    <View style={{ justifyContent: 'space-between', gap: 5, padding: GUTTER_SPACE * 2, paddingHorizontal: GUTTER_SPACE, backgroundColor: theme.backgroundBasicColor0, borderRadius: BORDER_RADIUS, width: (width - GUTTER_SPACE * 2 - 10) / 2, overflow: 'hidden' }}>
      <View>
        <View style={{ width: 50, height: 50, borderRadius: 50, backgroundColor: theme.backgroundBasicColor1, alignItems: 'center', justifyContent: 'center', marginBottom: GUTTER_SPACE }}>
