...
export default function PressableCard({ title, iconName, shotDescription, onPress }: {
  ...
  return (
    <View style={{ backgroundColor: theme.backgroundBasicColor2, borderRadius: BORDER_RADIUS, width: (width - GUTTER_SPACE * 2 - 10) / 2, overflow: 'hidden' }}>
      <PlatformPressable style={{ justifyContent: 'space-between', gap: 5, padding: GUTTER_SPACE, flex: 1 }} onPress={onPress}>
        <View>
