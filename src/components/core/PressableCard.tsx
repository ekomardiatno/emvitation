...
export default function PressableCard({ title, iconName, shotDescription, onPress }: {
  ...
  return (
    <View style={{ justifyContent: 'space-between', gap: 5, padding: GUTTER_SPACE * 2, paddingHorizontal: GUTTER_SPACE, backgroundColor: theme.backgroundBasicColor2, borderRadius: BORDER_RADIUS, width: '100%', overflow: 'hidden' }}>
      <View style={{ width: '100%', alignItems: 'center', justifyContent: 'center', height: (width - GUTTER_SPACE * 2) * .5 }}>
        <View style={{ width: 100, height: 100, borderRadius: 100, backgroundColor: theme.backgroundBasicColor3, alignItems: 'center', justifyContent: 'center', marginBottom: GUTTER_SPACE }}>
      ...
      <PlatformPressable pressColor={theme.backgroundBasicColor3} style={{ position: 'absolute', top: 0, left: 0, bottom: 0, right: 0 }} onPress={onPress}>
        <View></View>
      </PlatformPressable>
    </View>
  )
